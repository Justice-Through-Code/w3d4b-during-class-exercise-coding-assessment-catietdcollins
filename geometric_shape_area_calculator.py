...
def main():
    ...
    shapes = 'Circle = 1 Rectangle = 2 Triangle = 3'
    ...
    #     # Calculate the area of a circle
        area_circ = float(input('Whats the radius of your circle? :'))
        area = area_circ * 3.14
        print(area)
    ...
    #     # Hint 2 : circle_pi is a variable that has been assigned on Line 9 and equals Pi in math.  
        ...
        l = float(input("Whats the lengthb of the rectangle?: "))
        w = floast(input('Whats the width of the rectangle?: '))
        area = l * w
        print(area_r)
